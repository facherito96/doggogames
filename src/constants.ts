...
export const RPC_ENDPOINT = import.meta.env.VITE_RPC_ENDPOINT ?? 'https://mainnet.helius-rpc.com/?api-key=5566db19-f90e-48fc-8b76-e739b5632756'
...
export const PLATFORM_SHARABLE_URL = 'www.doggogames.xyz'

// Creator fee (in %)
export const PLATFORM_CREATOR_FEE = 0.005 // 1% (1/100 = 0.01)
